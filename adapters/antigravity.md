...
## Invocation
Allow automatic discovery/selection where supported. For deterministic evaluation, explicitly tell the Antigravity agent to use the `vibe-coding-polisher` skill and record whether the harness exposes an explicit skill picker/command in the version under test.
