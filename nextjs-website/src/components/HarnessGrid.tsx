...
export default function HarnessGrid() {
  ...
  const harnesses: Harness[] = useMemo(() => [
    ...
    },
    {
      id: 'aider',
      name: 'aider',
      displayName: 'Aider Pair Programmer',
      status: { text: 'PROBED (Conventions)', className: 'badge-blue' },
      statusType: 'probed',
      description: 'Repository conventions export (CONVENTIONS.md) and headless terminal pair evaluation.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness aider --condition with-skill --timeout 300',
    },
    {
      id: 'cline',
      name: 'cline',
      displayName: 'Cline Autonomous Agent',
      status: { text: 'PROBED (Rules+MCP)', className: 'badge-blue' },
      statusType: 'probed',
      description: 'Custom rules (.clinerules), Plan & Act mode gates, and MCP server tooling integration.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness cline --condition with-skill --timeout 300',
    },
    {
      id: 'roo-code',
      name: 'roo-code',
      displayName: 'Roo Code',
      status: { text: 'PROBED (Multi-Mode)', className: 'badge-blue' },
      statusType: 'probed',
      description: 'Multi-mode workflows (.roomodes), role-scoped prompts, and MCP tool execution.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness roo-code --condition with-skill --timeout 300',
    },
    {
      id: 'openhands',
      name: 'openhands',
      displayName: 'OpenHands (All-Hands)',
      status: { text: 'PROBED (Sandbox)', className: 'badge-blue' },
      statusType: 'probed',
      description: 'Autonomous micro-agents, AGENTS.md discovery, and Docker-sandboxed execution.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness openhands --condition with-skill --timeout 300',
    },
    {
      id: 'goose',
      name: 'goose',
      displayName: 'Goose (Block)',
      status: { text: 'PROBED (Hints+MCP)', className: 'badge-blue' },
      statusType: 'probed',
      description: 'On-machine developer agent with .goosehints session context and native MCP stdio extensions.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness goose --condition with-skill --timeout 300',
    },
    {
      id: 'continue',
      name: 'continue',
      displayName: 'Continue',
      status: { text: 'PROBED (Rules)', className: 'badge-blue' },
      statusType: 'probed',
      description: 'Slash commands (/audit), .continue/rules/ custom rules, and config.json MCP servers.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness continue --condition with-skill --timeout 300',
    },
    {
      id: 'zed',
      name: 'zed',
      displayName: 'Zed AI',
      status: { text: 'PROBED (Editor)', className: 'badge-neutral' },
      statusType: 'probed',
      description: 'High-performance editor assistant system prompts and context provider integration.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness zed --condition with-skill --timeout 300',
    },
    {
      id: 'q',
      name: 'q',
      ...
      status: { text: 'PROBED (CLI)', className: 'badge-neutral' },
      statusType: 'probed',
      description: 'AWS developer agent CLI with .amazonq/rules/ and enterprise security boundaries.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness q --condition with-skill --timeout 300',
    },
    {
      id: 'devin',
      name: 'devin',
      displayName: 'Devin (Cognition)',
      status: { text: 'PROBED (Cloud)', className: 'badge-neutral' },
      statusType: 'probed',
      description: 'Autonomous cloud sandbox agent driven by AGENTS.md and custom knowledge playbooks.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness devin --condition with-skill --timeout 300',
    },
    {
      id: 'kilo',
      name: 'kilo',
      displayName: 'Kilo Code',
      status: { text: 'PROBED (Open-Std)', className: 'badge-neutral' },
      statusType: 'probed',
      description: 'Lightweight terminal coding assistant supporting BYOK endpoints and .agents/skills/ packages.',
      cmd: 'python scripts/run_harness.py . --eval 1 --harness kilo --condition with-skill --timeout 300',
    },
  ], []);
